...
#' 
#' Contains stack of 4 predictors at ~20km resolution in Scandinavia at present time and 3 in 2041-2070 .
#'
...
#' \item{bio1_UKESM370}{Annual Mean Temperature averaged between 2041-2070 under the GCM 
#' UKESM 1-0-ll combined with the ssp -7.0}
#' \item{bio3_UKESM370}{Isothermalithy. It is equal to: Mean Diurnal 
#' Range/Temperature Annual Range * 100. The values have been averaged between 
#' 2041-2070 under the GCM UKESM 1-0-ll combined with the ssp 3-7.0}
#' \item{bio5_UKESM370}{Max Temperature of Warmest Month averaged between 2041-2070
#' under the GCM UKESM 1-0-ll combined with the ssp -7.0}
#' }
#' @details
