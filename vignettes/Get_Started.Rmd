...
sp.name <- "Tortella_pseudofragilis" #"Tayloria_serrata" #species selected
...
Once all the bivariate models and the ensemble model are build, you can evaluate them based on the pooling procedure as recommended in Collart & Guisan (2023).
